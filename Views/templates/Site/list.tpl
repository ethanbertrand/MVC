<h2><a class="btn btn-primary" href="index.php?page=site&action=add">Ajouter</a></h2>
<p>{$vue.description}<p>    
<div>
    <table class="table"><thead><tr><td>Libelle</td><td>Action</td></tr></thead>
        <tbody>
{foreach $vue.site as $cat}
    <tr><td>{$cat.libelle}<td>
        <td><a class="btn btn-primary" href="index.php?page=site&action=update&id={$cat.id}">modification</a>
